...
So in order to understand higher dimensions than 3, we have to stop thinking of shapes as we know it, and start thinking of shapes as a list of objects that are 1 dimension lower than the shape.